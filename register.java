...
public class register extends JFrame {
	...
	public register() {
		...
		password2Label.setFont(new Font("具愁磊 具眉 B", Font.PLAIN, 45));
		...
		nicknameLabel.setFont(new Font("具愁磊 具眉 B", Font.PLAIN, 45));
		...
		nickErrorLabel.setFont(new Font("具愁磊 具眉 B", Font.PLAIN, 30));
		...
		cancelButton.setFont(new Font("具愁磊 具眉 B", Font.PLAIN, 20));
