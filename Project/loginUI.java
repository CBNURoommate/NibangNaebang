...
public class loginUI extends JFrame {
	...
	public loginUI() {
		...
		registerButton.setBounds(1160, 490, 160, 50);
		...
		panel.setBounds(785, 155, 1, 600);
		contentPane.add(panel);
		
		JPanel panel_1 = new JPanel();
		panel_1.setBounds(379, 425, 900, 1);
