...
public class loginUI extends JFrame {
	...
	public loginUI() {
		...
		titleLabel.setFont(new Font("具愁磊 具眉 Bold", Font.BOLD, 120));
		titleLabel.setBounds(770, 239, 320, 135);
		contentPane.add(titleLabel);
		
		idField = new JTextField();
		idField.setFont(new Font("具愁磊 具眉 Bold", Font.PLAIN, 40));
		idField.setBounds(742, 399, 300, 50);
		contentPane.add(idField);
		idField.setColumns(10);
		
		JLabel idLabel = new JLabel("\uC544\uC774\uB514");
		idLabel.setFont(new Font("具愁磊 具眉 Bold", Font.PLAIN, 60));
		idLabel.setBounds(570, 389, 160, 70);
		contentPane.add(idLabel);
		
		JLabel passwordLabel = new JLabel("\uBE44\uBC00\uBC88\uD638");
		passwordLabel.setFont(new Font("具愁磊 具眉 Bold", Font.PLAIN, 60));
		passwordLabel.setBounds(570, 479, 160, 70);
		contentPane.add(passwordLabel);
		
		passwordField = new JPasswordField();
		passwordField.setEchoChar('*');
		passwordField.setFont(new Font("具愁磊 具眉 Bold", Font.PLAIN, 40));
		...
		pwerrorLabel.setFont(new Font("具愁磊 具眉 Bold", Font.PLAIN, 50));
		...
		loginButton.setFont(new Font("具愁磊 具眉 Bold", Font.PLAIN, 50));
		...
		registerButton.setFont(new Font("具愁磊 具眉 Bold", Font.PLAIN, 50));
		...
		lblNewLabel.setFont(new Font("具愁磊 具眉 Bold", Font.PLAIN, 50));
