...
=======
		titleLabel.setFont(new Font("��������", Font.BOLD, 120));
>>>>>>> branch 'main' of https://github.com/CBNURoommate/NibangNaebang.git
		...
		idLabel.setFont(new Font("야놀자 야체 B", Font.PLAIN, 60));
		idLabel.setBounds(570, 389, 160, 70);
		contentPane.add(idLabel);
		
		JLabel passwordLabel = new JLabel("\uBE44\uBC00\uBC88\uD638");
		passwordLabel.setFont(new Font("야놀자 야체 B", Font.PLAIN, 60));
...
>>>>>>> branch 'main' of https://github.com/CBNURoommate/NibangNaebang.git
		...
		pwerrorLabel.setFont(new Font("야놀자 야체 B", Font.PLAIN, 50));
		...
		loginButton.setFont(new Font("야놀자 야체 B", Font.PLAIN, 50));
		...
		registerButton.setFont(new Font("야놀자 야체 B", Font.PLAIN, 50));
		...
		lblNewLabel.setFont(new Font("야놀자 야체 B", Font.PLAIN, 50));
