...
public class main extends JFrame {
	...
	public main() {
		...
		titleLabel.setFont(new Font("�߳��� ��ü B", Font.BOLD, 50));
		...
		movePage1.setFont(new Font("�߳��� ��ü B", Font.PLAIN, 40));
		...
		movePage2.setFont(new Font("�߳��� ��ü B", Font.PLAIN, 40));
		...
		movePage3.setFont(new Font("�߳��� ��ü B", Font.PLAIN, 40));
		...
		textPane.setFont(new Font("�߳��� ��ü B", Font.PLAIN, 40));
		...
		movePage4.setFont(new Font("�߳��� ��ü B", Font.PLAIN, 40));
