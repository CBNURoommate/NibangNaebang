...
public class randomMatching extends JFrame {
	...
	public randomMatching() {
		...
		line2.setBounds(36, 112, 652, 1);
		contentPane.add(line2);
		
		JPanel line1 = new JPanel();
		line1.setLayout(null);
		line1.setBackground(Color.BLACK);
		line1.setBounds(209, 60, 1, 20);
		...
		movePage1.setBounds(213, 30, 195, 72);
		contentPane.add(movePage1);
		
		JButton movePage4 = new JButton("\uB0B4\uBC29 \uC18C\uAC1C\uD558\uAE30");
		movePage4.setFont(new Font("具愁磊 具眉 B", Font.PLAIN, 40));
		...
		movePage4.setBounds(393, 24, 209, 72);
		...
		movePage2.setBounds(600, 23, 195, 72);
		contentPane.add(movePage2);
		
		JButton movePage3 = new JButton("\uB2C8\uBC29 \uCC3E\uC544\uBCF4\uAE30");
		movePage3.setFont(new Font("具愁磊 具眉 B", Font.PLAIN, 40));
		...
		Label0_1.setFont(new Font("具愁磊 具眉 B", Font.PLAIN, 50));
		...
		Label1_1.setFont(new Font("具愁磊 具眉 B", Font.PLAIN, 50));
		Label1_1.setBounds(12, 18, 429, 49);
		panel1.add(Label1_1);
		
		JLabel Label1_2 = new JLabel("\uC0DD\uB144");
		Label1_2.setFont(new Font("具愁磊 具眉 B", Font.PLAIN, 50));
		Label1_2.setBounds(44, 77, 115, 49);
		panel1.add(Label1_2);
		
		JLabel Label1_3 = new JLabel("1 / ?");
		Label1_3.setFont(new Font("具愁磊 具眉 B", Font.PLAIN, 50));
		...
		Label2_1.setFont(new Font("具愁磊 具眉 B", Font.PLAIN, 50));
		Label2_1.setBounds(12, 18, 429, 49);
		panel2.add(Label2_1);
		
		JLabel Label2_2 = new JLabel("\uD559\uBC88");
		Label2_2.setFont(new Font("具愁磊 具眉 B", Font.PLAIN, 50));
		Label2_2.setBounds(44, 77, 115, 49);
		panel2.add(Label2_2);
		
		JLabel Label2_3 = new JLabel("2 / ?");
		Label2_3.setFont(new Font("具愁磊 具眉 B", Font.PLAIN, 50));
		...
		Label3_1.setFont(new Font("具愁磊 具眉 B", Font.PLAIN, 50));
		Label3_1.setBounds(12, 18, 429, 49);
		panel3.add(Label3_1);
		
		JLabel Label3_2 = new JLabel("\uD761\uC5F0\uC5EC\uBD80");
		Label3_2.setFont(new Font("具愁磊 具眉 B", Font.PLAIN, 50));
		Label3_2.setBounds(44, 77, 157, 49);
		panel3.add(Label3_2);
		
		JLabel Label3_3 = new JLabel("3 / ?");
		Label3_3.setFont(new Font("具愁磊 具眉 B", Font.PLAIN, 50));
		...
		Label4_1.setFont(new Font("具愁磊 具眉 B", Font.PLAIN, 50));
		Label4_1.setBounds(12, 18, 429, 49);
		panel4.add(Label4_1);
		
		JLabel Label4_2 = new JLabel("\uB2E8\uACFC");
		Label4_2.setFont(new Font("具愁磊 具眉 B", Font.PLAIN, 50));
		Label4_2.setBounds(44, 77, 157, 49);
		panel4.add(Label4_2);
		
		JLabel Label4_3 = new JLabel("4 / ?");
		Label4_3.setFont(new Font("具愁磊 具眉 B", Font.PLAIN, 50));
		...
		Label5_1.setFont(new Font("具愁磊 具眉 B", Font.PLAIN, 50));
		Label5_1.setBounds(12, 18, 429, 49);
		panel5.add(Label5_1);
		
		JLabel Label5_2 = new JLabel("\uC18C\uB9AC");
		Label5_2.setFont(new Font("具愁磊 具眉 B", Font.PLAIN, 50));
		Label5_2.setBounds(44, 77, 157, 49);
		panel5.add(Label5_2);
		
		JLabel Label5_3 = new JLabel("5 / ?");
		Label5_3.setFont(new Font("具愁磊 具眉 B", Font.PLAIN, 50));
		...
		Label6_1.setFont(new Font("具愁磊 具眉 B", Font.PLAIN, 50));
		Label6_1.setBounds(12, 18, 429, 49);
		panel6.add(Label6_1);
		
		JLabel Label6_2 = new JLabel("\uD5A5\uC218");
		Label6_2.setFont(new Font("具愁磊 具眉 B", Font.PLAIN, 50));
		Label6_2.setBounds(44, 77, 157, 49);
		panel6.add(Label6_2);
		
		JLabel Label6_3 = new JLabel("6 / ?");
		Label6_3.setFont(new Font("具愁磊 具眉 B", Font.PLAIN, 50));
