...
public class login extends JFrame {
	...
	public login() {
		...
		titleLabel.setFont(new Font("具愁磊 具眉 B", Font.BOLD, 100));
		titleLabel.setBounds(442, 121, 367, 138);
		contentPane.add(titleLabel);
		
		idField = new JTextField();
		idField.setFont(new Font("具愁磊 具眉 B", Font.PLAIN, 24));
		idField.setBounds(467, 332, 300, 40);
		contentPane.add(idField);
		idField.setColumns(10);
		
		JLabel idLabel = new JLabel("\uC544\uC774\uB514");
		idLabel.setFont(new Font("具愁磊 具眉 B", Font.PLAIN, 45));
		idLabel.setBounds(274, 321, 97, 63);
		contentPane.add(idLabel);
		
		JLabel passwordLabel = new JLabel("\uBE44\uBC00\uBC88\uD638");
		passwordLabel.setFont(new Font("具愁磊 具眉 B", Font.PLAIN, 45));
		passwordLabel.setBounds(284, 385, 186, 58);
		contentPane.add(passwordLabel);
		
		passwordField = new JPasswordField();
		passwordField.setEchoChar('*');
		passwordField.setFont(new Font("具愁磊 具眉 B", Font.PLAIN, 24));
		passwordField.setBounds(467, 405, 300, 40);
		contentPane.add(passwordField);
		
		JButton loginButton = new JButton("\uB85C\uADF8\uC778");
		loginButton.setFont(new Font("具愁磊 具眉 B", Font.PLAIN, 20));
		...
		errorLabel.setFont(new Font("具愁磊 具眉 B", Font.PLAIN, 30));
		...
		lblNewLabel.setFont(new Font("具愁磊 具眉 B", Font.PLAIN, 35));
